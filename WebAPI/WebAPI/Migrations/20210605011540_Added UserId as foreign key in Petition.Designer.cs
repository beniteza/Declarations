...
namespace WebAPI.Migrations
{
    ...
    [Migration("20210605011540_Added UserId as foreign key in Petition")]
    partial class AddedUserIdasforeignkeyinPetition
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebAPI.Models.Application.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("WebAPI.Models.Application.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("WebAPI.Models.Application.Petition", b =>
                {
                    b.HasOne("WebAPI.Models.Application.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
